...
export default function HomeScreen() {
  ...
  const handleSearch = async () => {
    if (!from || !to) {
      showAlert("Notification", 'Please enter origin and destination');
      return;
    }
    ...
    <SafeAreaView style={styles.safeArea} edges={['top']}>
      <ScrollView contentContainerStyle={styles.scrollContainer} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
        ...
        <View style={[styles.searchCard, { zIndex: 99, elevation: 10 }]}>
          {/* From */}
          <View style={[styles.inputRow, { zIndex: 10, elevation: 10 }]}>
          ...
          {/* Date */}
          <View style={[styles.inputRow, { zIndex: 8, elevation: 8 }]}>
          ...
          <View style={styles.inputRow}>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 4 }}>
              <TouchableOpacity
                ...
                activeOpacity={0.7}
              >
                <Feather name="minus" size={20} color={passengers > 1 ? "#111827" : "#D1D5DB"} />
              </TouchableOpacity>
              
              <Text style={{ fontSize: 18, fontFamily: 'Outfit_600SemiBold', color: '#111827', minWidth: 40, textAlign: 'center' }}>
                {passengers}
              </Text>
              ...
              <TouchableOpacity
                ...
                activeOpacity={0.7}
              >
                <Feather name="plus" size={20} color={passengers < 6 ? "#111827" : "#D1D5DB"} />
              </TouchableOpacity>
            </View>
          </View>
...
const styles = StyleSheet.create({
  ...
  divider: {
    height: 1,
    backgroundColor: '#F3F4F6', // Lighter divider color
    marginHorizontal: 20,
  },
  searchButton: {
    paddingVertical: 16, 
